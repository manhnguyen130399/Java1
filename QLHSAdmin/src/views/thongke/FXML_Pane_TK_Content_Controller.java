 ...
 * @author Computer
 */
public class FXML_Pane_TK_Content_Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            ///Tính tổng hs nữ///
            connection = DataController.getInstance().ConnectDatabase();
            query = "SELECT COUNT(*) AS 'TONGHSNU' FROM HOCSINH WHERE GIOITINH = 1";
            resultSet = DataController.getInstance().ExecuteQuery(connection, query);
            if (resultSet.next()) {
            ...
            connection = DataController.getInstance().ConnectDatabase();
            query = "SELECT COUNT(*) AS 'TONGHSNUDANTOC' FROM HOCSINH WHERE GIOITINH = 1 AND DANTOC <> N'Kinh'";
            resultSet = DataController.getInstance().ExecuteQuery(connection, query);
            if (resultSet.next()) {
            ...
            ///Tính tổng hs nam///
            connection = DataController.getInstance().ConnectDatabase();
            query = "SELECT COUNT(*) AS 'TONGHSNAM' FROM HOCSINH WHERE GIOITINH = 0";
            resultSet = DataController.getInstance().ExecuteQuery(connection, query);
            if (resultSet.next()) {
            ...
            connection = DataController.getInstance().ConnectDatabase();
            query = "SELECT COUNT(*) AS 'TONGHSNAMDANTOC' FROM HOCSINH WHERE GIOITINH = 0 AND DANTOC <> N'Kinh'";
            resultSet = DataController.getInstance().ExecuteQuery(connection, query);
            if (resultSet.next()) {
